...
public Prog340() {
	...
	inputFile = null;
   	...
   	comboBoxList[0] = new String("To begin first select file");
   	comboBoxList[1] = new String("prog340:  Select file and read graph");
   	comboBoxList[2] = new String("Deliv A:  Write Graph Info");
   	comboBoxList[3] = new String("Deliv B:  DFS");
   	comboBoxList[4] = new String("Deliv C:  Constraint Satisfaction");
   	comboBoxList[5] = new String("Deliv D:  Distances");
   	comboBoxList[6] = new String("exit");
